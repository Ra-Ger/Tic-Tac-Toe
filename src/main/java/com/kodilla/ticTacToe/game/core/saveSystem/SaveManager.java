...
public class SaveManager {
    ...
    public static GameStats loadGame() {
        ...
        try (FileInputStream in = new FileInputStream(file)) {
            ...
            // Rekonstrukcja tablicy char[][] ze Stringa
            String boardStr = props.getProperty("board", ".........");
            char[][] loadedBoard = new char[3][3];
            for (int i = 0; i < 9; i++) {
                char c = boardStr.charAt(i);
                // Zamiana kropki z powrotem na pusty znak \0
                loadedBoard[i / 3][i % 3] = (c == '.' ? '\0' : c);
            }
